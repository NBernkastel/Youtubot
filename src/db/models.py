...
class Channels(Base):
    ...
    youtube_analytic_credits: Mapped[str] = mapped_column(nullable=False, default=None)
    youtube_analytic_token: Mapped[str] = mapped_column(nullable=False, default=None)
    youtube_data_credits: Mapped[str] = mapped_column(nullable=False, default=None)
