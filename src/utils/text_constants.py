HELP_TEXT = (
    ...
    "Выберите команду, чтобы узнать подробнее."
)
...
WRONG_FILE = 'Пожалуйста отправте фото формате png или jpg'
...
SUB_WAS_ENDED = 'Ваша подписка истекала, пожалуйста продлите'
